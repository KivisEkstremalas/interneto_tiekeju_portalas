 ...
 */
final class Version20191109121959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__purchase AS SELECT id, provider_id, purchase, date FROM purchase');
        $this->addSql('DROP TABLE purchase');
        $this->addSql('CREATE TABLE purchase (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, provider_id INTEGER DEFAULT NULL, purchase VARCHAR(255) NOT NULL COLLATE BINARY, date DATETIME NOT NULL, CONSTRAINT FK_6117D13BA53A8AA FOREIGN KEY (provider_id) REFERENCES provider (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO purchase (id, provider_id, purchase, date) SELECT id, provider_id, purchase, date FROM __temp__purchase');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__purchase AS SELECT id, provider_id, purchase, date FROM purchase');
        $this->addSql('DROP TABLE purchase');
        $this->addSql('CREATE TABLE purchase (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, provider_id INTEGER DEFAULT NULL, purchase VARCHAR(255) NOT NULL, date DATETIME NOT NULL)');
        $this->addSql('INSERT INTO purchase (id, provider_id, purchase, date) SELECT id, provider_id, purchase, date FROM __temp__purchase');
        $this->addSql('DROP TABLE __temp__purchase');
        $this->addSql('CREATE INDEX IDX_6117D13BA53A8AA ON purchase (provider_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74');
