 ...
 */
final class Version20191109133603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__payment AS SELECT id, client_id, paid FROM payment');
        $this->addSql('DROP TABLE payment');
        $this->addSql('CREATE TABLE payment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_id INTEGER DEFAULT NULL, paid BOOLEAN NOT NULL, amount DOUBLE PRECISION NOT NULL, date DATETIME NOT NULL, CONSTRAINT FK_6D28840D19EB6921 FOREIGN KEY (client_id) REFERENCES client (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO payment (id, client_id, paid) SELECT id, client_id, paid FROM __temp__payment');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__payment AS SELECT id, client_id, paid FROM payment');
        $this->addSql('DROP TABLE payment');
        $this->addSql('CREATE TABLE payment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_id INTEGER DEFAULT NULL, paid BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO payment (id, client_id, paid) SELECT id, client_id, paid FROM __temp__payment');
        $this->addSql('DROP TABLE __temp__payment');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6D28840D19EB6921 ON payment (client_id)');
        $this->addSql('DROP INDEX UNIQ_92C4739CA76ED395');
